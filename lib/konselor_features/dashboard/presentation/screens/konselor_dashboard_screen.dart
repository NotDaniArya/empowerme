...
import 'package:new_empowerme/konselor_features/dashboard/presentation/providers/konselor_dashboard_provider.dart';
...
class KonselorDashboardScreen extends ConsumerWidget {
  const KonselorDashboardScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final dashboardState = ref.watch(konselorDashboardViewModel);

    return Scaffold(
      backgroundColor: TColors.backgroundColor,
      appBar: const MyAppBar(),
      body: RefreshIndicator(
        onRefresh: () async => ref.invalidate(konselorDashboardViewModel),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Berikut adalah data terbaru pasien baru.',
          ...
          _DashboardCard(
            ...
            value: dashboard.totalNewPatient.toString(),
