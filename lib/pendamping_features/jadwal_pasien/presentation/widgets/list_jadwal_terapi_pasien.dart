...
class ListJadwalTerapiPasien extends ConsumerStatefulWidget {
  const ListJadwalTerapiPasien({super.key});

  @override
  ConsumerState<ListJadwalTerapiPasien> createState() =>
      _ListJadwalTerapiPasienState();
}

class _ListJadwalTerapiPasienState
    extends ConsumerState<ListJadwalTerapiPasien> {
  ...
  Widget build(BuildContext context) {
    ...
    final jadwalState = ref.watch(jadwalTerapiPasienViewModel(selectedApiKey));
